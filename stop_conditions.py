...
class StopConditions:
    ...
    def update(self, gradient: Vector, error: float, iterated: int = 1) -> Tuple[Optional['StopConditions'], bool]:
        ...
        new_condition = StopConditions(self._gradient_eps, self._error_eps, iterations_left)
